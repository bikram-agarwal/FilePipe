...
| **Update Check Source** | GitHub Release API for `bikram-agarwal/filepipe` | F-Droid package API for the installed package ID | Google Play Core In-App Updates | You share it to ObtainX, and track upates there |
